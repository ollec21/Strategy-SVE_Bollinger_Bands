...
struct Indi_SVE_Bollinger_Bands_Params_H4 : Indi_SVE_Bollinger_Bands_Params {
  Indi_SVE_Bollinger_Bands_Params_H4() : Indi_SVE_Bollinger_Bands_Params(indi_svebbands_defaults, PERIOD_H4) {
    shift = 0;
  }
} indi_svebbands_h4;
